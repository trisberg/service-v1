...
func TestReconcile(t *testing.T) {
	...
	instance := &servicev1alpha1.Binding{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	g.Eventually(func() error { return c.Get(context.TODO(), depKey, secret) }, timeout).
